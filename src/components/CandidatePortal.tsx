    ...
    <div className="candidate-app">
      ...
      <header className="candidate-header">
        ...
        <nav aria-label="Candidate navigation">
          ...
          <NavLink to="/support">Candidate support</NavLink>
        </nav>
      ...
      <footer className="candidate-footer" id="candidate-support">
        ...
        <nav aria-label="Footer"><NavLink to="/sign-in">Account access</NavLink><NavLink to="/privacy-requests">Privacy requests</NavLink><NavLink to="/support/new?topic=accessibility">Accessibility support</NavLink><NavLink to="/support">Contact demo support</NavLink></nav>
      </footer>
    </div>
  );
}
      ...
      <div className="candidate-page narrow-page">
        ...
        <div className="job-detail-grid">
          ...
          <aside className="apply-card">
            ...
            <button className="secondary-button full-button" aria-pressed={saved} onClick={() => setSaved((current) => !current)}><Save size={16} /> {saved ? "Saved in this session" : "Save this job"}</button>
            ...
            <div className="support-link"><CircleHelp size={18} /><span>Need an accommodation?<NavLink to="/support/new?topic=accessibility"> Open private support</NavLink></span></div>
          </aside>
        </div>
      </div>
    </CandidateShell>
...
function ApplyScreen() {
  ...
  if (!job) return <CandidateShell><section className="candidate-page empty-state"><BriefcaseBusiness size={28} /><h1>Application link unavailable</h1><p>The linked job is no longer available, so no application can be started.</p><NavLink className="primary-button" to="/careers">Return to current roles</NavLink></section></CandidateShell>;
