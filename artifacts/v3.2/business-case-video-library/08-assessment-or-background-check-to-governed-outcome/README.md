...
A correctable, human-reviewed outcome preserves notice, response windows and redress.

- Primary record: `CTK-004`
- P0 workbench: `WF-P0-11`
- Client demo: `client-demo.mp4` (3:45, 1,920×1,080, 9 chapters, 36 caption cues)
