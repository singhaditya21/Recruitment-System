...
An authorized human records an attributed decision using independent, versioned evidence.

- Primary record: `APP-DEMO-001`
- P0 workbench: `WF-P0-10`
- Client demo: `client-demo.mp4` (3:37, 1,920×1,080, 9 chapters, 36 caption cues)
